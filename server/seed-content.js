  ...
  const gameConfigs = {
    ...
    'scenario': {
      ...
      config: {
        scenarios: [
          {
            situation: 'A state government passes a law restricting free speech in certain contexts.',
            question: 'Is this constitutional?',
            options: [
              { text: 'Yes, states have complete authority over speech', isCorrect: false },
              { text: 'Yes, if it falls under reasonable restrictions in Article 19(2)', isCorrect: true },
              { text: 'No, free speech cannot be restricted under any circumstances', isCorrect: false },
              { text: 'No, only the central government can restrict speech', isCorrect: false }
            ]
          },
          {
            situation: 'A private company denies employment to someone based on their religion.',
            question: 'Does this violate Fundamental Rights?',
            options: [
              { text: 'Yes, it violates Article 15', isCorrect: false },
              { text: 'Yes, it violates Article 16', isCorrect: false },
              { text: 'No, Fundamental Rights are enforceable only against the State', isCorrect: true },
              { text: 'No, religious discrimination is permitted', isCorrect: false }
            ]
          }
        ],
        timeLimit: 300
    ...
    'spiral': {
      type: 'spiral',
      config: {
        centerConcept: topic.title,
        branches: [
          {
            name: 'Historical Context',
            concepts: ['Origins', 'Development', 'Key Figures']
          },
          {
            name: 'Legal Framework',
            concepts: ['Articles', 'Amendments', 'Interpretations']
          },
          {
            name: 'Application',
            concepts: ['Case Studies', 'Modern Relevance', 'Challenges']
          }
        ],
        timeLimit: 420
      }
